          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <Link href="/" className="text-2xl font-bold text-white animate-fadeInSlide">
                  SkilLease
                </Link>
              </div>
              
              <div className="hidden md:flex items-center space-x-8">
                <Link href="/services" className="text-white/70 hover:text-teal-300 font-medium transition-colors animate-fadeInSlide delay-200">
                  Browse Services
                </Link>
                <Link href="/provider-dashboard" className="text-white/70 hover:text-teal-300 font-medium transition-colors animate-fadeInSlide delay-200">
                  For Providers
                </Link>
              </div>
              ...
              <div className="flex items-center space-x-4">
                {user ? (
                  <div className="flex items-center space-x-3">
                    <span className="text-white/70 animate-fadeInSlide delay-200">Hi, {user.email?.split('@')[0]}!</span>
                    <Link 
                      href="/dashboard"
        ...
        <section className="py-20 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl p-8 mb-16 animate-slideUp">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 animate-fadeInSlide">Popular Categories</h2>
              <p className="text-xl text-white/70 animate-fadeInSlide delay-200">Discover services across different categories</p>
            </div>
              ...
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/70 mb-6 text-lg">{category.count} providers available</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="group text-center bg-black/30 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-teal-300 transition-all duration-300 hover:scale-105 animate-slideUp">
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-white/70">
                  <li><Link href="/services" className="hover:text-teal-300 transition-colors">Browse Services</Link></li>
                  <li><Link href="/signup" className="hover:text-teal-300 transition-colors">Sign Up</Link></li>
                  <li><Link href="/login" className="hover:text-teal-300 transition-colors">Login</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-white/70">
                  <li><Link href="/provider-dashboard" className="hover:text-teal-300 transition-colors">Provider Dashboard</Link></li>
                  <li><Link href="/signup" className="hover:text-teal-300 transition-colors">Join as Provider</Link></li>
                </ul>
              </div>
