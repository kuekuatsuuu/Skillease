...
export default function BookingCard({
    ...
    try {
      ...
      if (booking.services?.latitude && booking.services?.longitude) {
        ...
        const lat =
          ...
          (randomDistance / 111) * Math.cos(randomAngle);
        const lng =
  ...
  const calculateTravelTime = async () => {
    ...
    try {
      ...
      console.log(
        "Travel time estimation failed, using distance-based estimate"
      );
  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      ...
      if (newStatus === "confirmed") {
        updateData.provider_notes = `Booking accepted. Customer is ${formatDistance(
          distance
        )} away.`;
        ...
        toast.success(
          "Booking accepted! Customer will be notified for payment."
        );
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium">
              {booking.profiles?.full_name || "Not provided"}
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium">
              {booking.duration_hours || 1} hour(s)
            </span>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-4 border border-blue-200">
          ...
          {trackingLocation ? (
            ...
            <div className="text-center py-4 text-gray-500">
              ...
              <p>
                Customer location will be available when you accept the booking
              </p>
            </div>
          )}
        </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-4 flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700">
                  Customer is {formatDistance(distance)} away. Consider if this
                  distance works for you.
                </p>
              </div>
            </div>
          )}
      ...
      {isProvider && booking.status === "confirmed" && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-green-700">
            Customer has been notified and will complete payment. You will
            receive confirmation once payment is done.
          </p>
        </div>
      )}
