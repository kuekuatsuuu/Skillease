  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      const stats = {
        ...
        totalSpent: bookingsData?.reduce((sum, b) => sum + (parseFloat(b.total_price) || 0), 0) || 0,
              ...
              <div className="relative z-10">
                ...
                <p className="text-blue-100 text-lg mb-6">
                  {stats.totalBookings > 0 
                    ? `You have ${stats.totalBookings} bookings and have spent ₹${stats.totalSpent.toLocaleString()} on services.`
                    : "🔍 Ready to discover amazing local services in your area!"
                  }
                </p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-3xl font-bold text-gray-900">{stats.reviewsGiven}</p>
                </div>
              </div>
            </div>
          </div>
